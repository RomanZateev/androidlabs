    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            ...
            case TYPE_STUDENT:
                ...
                studentHolder.lastName.setText(
                        "Имя: " + student.lastName);
                studentHolder.firstName.setText(
                        "Фамилия: " + student.firstName);
                studentHolder.secondName.setText(
                        "Отчество: " + student.secondName);
                studentHolder.groupNumber.setText(
                        "Номер группы: " + student.groupNumber);
                studentHolder.sex.setText(
                        "Пол: " + student.sex);
                break;
        }
    }
